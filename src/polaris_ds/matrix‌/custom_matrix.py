...
class CustomMatrix(object):
    ...
    @property
    def T(self):
        b = CustomMatrix([t for i in self.__data for t in i])
    ...
    def __add__(self, n):
        ...
        elif isinstance(n, CustomMatrix):
            ...
            if n.__row == self.__col:
                ...
                for row in self.__data:
                    ...
                    for ii in range(n.__col):
                        ...
                        t.append(tt)
                    data.append(t)
                c = CustomMatrix([t for i in data for t in i])

...
"""
descr: 模拟生成产品库存的信息数据集
auther: lj.michale
create_date: 2025/10/30 15:54
file_name: inventory_dataset.py
"""
...
def create_structured_product_inventory(id):
    """
    生成产品信息结构
    :return:
    """
...
def generate_product_inventory_dataset(data_size=100, ration=0):
    """
    模拟生成产品库存的信息数据集
    :param data_size:
    :param ration:
    ...
    for id in ids:
        datas.append(create_structured_product_inventory(id))
...
if __name__ == '__main__':
    ...
    ration = 0   # 确定重复比例
    gis_dataset = generate_product_inventory_dataset(data_size,ration)

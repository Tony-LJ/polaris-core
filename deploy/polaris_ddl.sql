...
create table if not exists utc.polaris_vocabulary_mapping (
    ...
    field_en_upper varchar(50) default null COMMENT '大写英语字段',
    abbreviate varchar(50) default null COMMENT '字段缩写',
    abbreviate_upper varchar(50) default null COMMENT '大写字段缩写',
    descri varchar(200) default null COMMENT '字段描述',
    create_by varchar(64) default null comment '创建人',
    create_time datetime default current_timestamp comment '创建时间',
    update_by varchar(64) default null comment '更新人',
    update_time datetime default current_timestamp comment '更新时间',
    is_delete varchar(20) default '0' COMMENT '是否删除',
